...
from Utils.paths import radical_path,ftradical_path
...
# char=[]
# with open(radical_path, 'r',encoding='utf-8') as f:
#     with open(ftradical_path, 'r', encoding='utf-8') as f1:
#         lines = f.readlines()
#         lines1 = f1.readlines()
#         for line1 in lines1:
#             info1.append( line1.split('\t', 1)[1])
#         for line in lines:
#             char.append( line.split('\t', 1)[0])
# char_info=dict(zip(char,info1))
