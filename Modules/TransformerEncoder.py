...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, query, key, value, seq_len, lex_num=0, pos_s=None, pos_e=None):
        rel_pos_embedding,pos_ss,pos_ee, = self.four_pos_fusion_embedding(pos_s, pos_e)

        output = self.transformer_layer(query, key, value, seq_len,pos_ss,pos_ee, lex_num=lex_num,
