...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, query, key, value, seq_len,pos_ss,pos_ee, lex_num=0, rel_pos_embedding=None):

        output = self.attn(query, key, value, seq_len,pos_ss,pos_ee, lex_num=lex_num,
